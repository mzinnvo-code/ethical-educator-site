# Illustration Credits & Provenance

All PNG and WebP files in this directory and its subdirectories (`educators/`, `ai-education/`, `experiment-scenes/`, etc.) were generated using **OpenAI's DALL·E** image-generation model, prompted by the site author (Matthew A. Zinn) to match the style guide in [README.md](./README.md).
...
This note exists so that the provenance of every visual asset on the site is documented in one place. If you ever switch image-generation tools, add commissioned art, or accept third-party submissions, record the source, license, and date here for each batch.

        ...
        <Narrow>
          ...
          <FadeIn delay={0.06}>
            <Expandable title="What the Evidence Actually Says (2024–2026)" color={C.teal} tag="Evidence" defaultOpen>
              ...
              <p style={{ marginTop: 12 }}>That same boundary question drives <a href="#" onClick={(e) => { e.preventDefault(); navigate("ai-consciousness"); }} style={{ color: C.gold }}>The Consciousness Line</a>: when a system becomes more fluent, adaptive, or biologically entangled, what should educators teach students to notice before they make moral shortcuts?</p>
            </Expandable>
          </FadeIn>

        ...
        <Narrow>
          ...
          <FadeIn delay={0.06}>
            <Expandable title="What the Evidence Actually Says (2024–2026)" color={C.teal} tag="Evidence" defaultOpen>
              ...
              <p style={{ marginTop: 12 }}><strong>Key insight:</strong> AI tools are effective when they support knowledge construction and provide scaffolding. They are harmful when they replace the cognitive work that produces genuine learning. This distinction maps directly onto the philosophical question raised by the Learning Pill: <a href="#" onClick={(e) => { e.preventDefault(); navigate("thought-experiments"); }} style={{ color: C.teal }}>is the process of learning constitutive of its value?</a></p>
            </Expandable>
          </FadeIn>

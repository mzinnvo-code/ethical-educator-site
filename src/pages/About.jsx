...
import { FadeIn, Expandable, BodyText, PageContainer, Narrow, Divider, QuoteBlock, ImagePageHeader } from "../components/shared.jsx";
  ...
  return (
    <div style={{ padding: "80px 0", background: C.bg }}>
      <PageContainer>
        <ImagePageHeader
          label="About"
          title="Matthew A. Zinn"
          subtitle="Philosopher, educator, and technologist working where moral psychology, AI ethics, and classroom reality meet."
          minutes={8}
          image={getFeatureIllustration("site-symbol")}
          accent={C.teal}
        />
        <div className="grid-2" style={{ marginTop: 28, alignItems: "start" }}>
          ...
          <FadeIn delay={0.12}>
            ...
            <BodyText>As an educator, I've spent years in classrooms with students of all ages. I began my career in early childhood education — working with children from infancy through pre-K — before moving into special education. That experience gave me a deep appreciation for individualized instruction — and for how much of a teacher's day is consumed by tasks that pull them away from what matters most: connecting with students.</BodyText>
        ...
        <Narrow>
          ...
          <FadeIn delay={0.06}>
            <Expandable title="Matthew A. Zinn's AI education blog" color={C.teal}>

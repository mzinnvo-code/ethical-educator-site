...
import { FadeIn, Expandable, Narrow, PageContainer, RefItem, ContinueExploring, ImagePageHeader } from "../components/shared.jsx";
  ...
  return (
    <div style={{ padding: "80px 0", background: C.bgAlt }}>
      <PageContainer>
        <ImagePageHeader
          label="Library"
          title="Essential Reading & Resources"
          subtitle="Curated books, papers, organizations, policy frameworks, and podcasts for deeper work in moral psychology, AI ethics, and philosophy of education."
          minutes={6}
          readingLabel="6 min browsable"
          image={getFeatureIllustration("resources")}
          accent={C.gold}
        />
        <Narrow>
          <FadeIn delay={0.06}>

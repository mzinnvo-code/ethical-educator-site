        ...
        <Narrow>
          ...
          <FadeIn delay={0.06}>
            <Expandable title="Verified sources used in this article" color={C.ocean} tag="Sources">
              <RefItem><LinkOut href={links.wpOrigin}>Matthew A. Zinn. "From Ambiguity to Action: Navigating Ethical Challenges in AI-Enhanced Education." Matthew A. Zinn's AI education blog, July 12, 2024. (Original publication; this article is the expanded internal treatment.)</LinkOut></RefItem>

        ...
        <Narrow>
          ...
          <FadeIn delay={0.06}>
            <Expandable title="Verified sources used in this article" color={C.ocean} tag="Sources">
              <RefItem><LinkOut href={links.wpOrigin}>Matthew A. Zinn. "Response to Why AI Won't Replace Teachers." Matthew A. Zinn's AI education blog, February 14, 2024. (Original publication; this article is the expanded internal treatment.)</LinkOut></RefItem>

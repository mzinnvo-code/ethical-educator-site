        ...
        <Narrow>
          ...
          <FadeIn delay={0.1}>
            <Expandable title="3. Predictions about AI's ceiling have aged badly" color={C.ocean} tag="Track record">
              <p>The track record of "AI will never X" predictions is worse than the track record of "AI will be doing X by year Y" predictions, and both are worse than chance. Three months before ChatGPT's public release in November 2022, the prevailing assumption was that fluent long-form text generation — the kind that didn't hallucinate basic facts — was still years away. Two years later, ~92% of UK undergraduates reported using AI tools (HEPI 2025), and the Digital Education Council's 2024 global survey put the figure at 86% of students worldwide.</p>

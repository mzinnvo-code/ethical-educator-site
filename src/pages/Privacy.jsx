        ...
        <Narrow>
          <div style={{ marginTop: 32, color: C.textSecondary, lineHeight: 1.8, fontSize: "0.94rem" }}>
            ...
            <FadeIn delay={0.1}>
              ...
              <p style={{ marginTop: 10 }}>If you opt in to the <strong>Decision Journal</strong> by clicking <em>Save to journal</em> at the end of any thought experiment, your saved entries are written to your browser's <code>localStorage</code> on this device only. The optional Thought Experiments progress panel also stores local progress signals, such as completed dilemmas, reasoning lenses, replays, and earned mastery badges, in <code>localStorage</code>. The Gamification in Education playable quest stores local-only progress in <code>localStorage</code> too, including door progress, completed rooms, earned badges, mute preference, and finale state, along with the text speed, calm-motion, grade-band, and music preferences for its dialogue and classroom examples. Nothing is transmitted to any server, and no account is created. You can export your journal as a Markdown file, clear journal entries from the Decision Journal page, reset Thought Experiments progress from the progress panel, or reset the Gamification in Education quest from its in-game controls. Clearing your browser's site data also erases these local features.</p>
            </FadeIn>
            ...
            <FadeIn delay={0.16}>
              ...
              <p style={{ marginTop: 10 }}>We do not knowingly collect personal information from any visitor, including children under 13. The optional Decision Journal, Thought Experiments progress panel, and Gamification in Education quest store entries and progress only in the user's own browser via <code>localStorage</code> and never transmit them. If you believe a child has provided information through any future feature in a way that conflicts with this policy, please contact <a href="mailto:hello@examinedclassroom.com" style={{ color: C.gold, textDecoration: "underline" }}>hello@examinedclassroom.com</a>.</p>
            </FadeIn>
            ...
            <FadeIn delay={0.18}>
              ...
              <ul style={{ paddingLeft: 20, lineHeight: 2 }}>
                ...
                <li><strong style={{ color: C.textPrimary }}>Right to delete / erasure:</strong> you can clear your browser's site data to erase any locally stored Decision Journal entries, Thought Experiments progress, and Gamification in Education quest progress.</li>

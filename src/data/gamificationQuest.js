...
export const GAMIFICATION_GAME_ROOMS = [
  ...
  },
  {
    ...
    dialogueBeats: [
      ...
      "There is a name for why a visible loop helps: the goal-gradient effect. People push harder as a goal looks closer - first shown in the lab with rats, then confirmed in classrooms and reward programs. A visible loop turns a far, vague task into a near, concrete one.",
  ...
  },
  {
    ...
    keyDistinction: {
      ...
      note: "Neuroscientists Wolfram Schultz (reward-prediction signals) and Kent Berridge (who separated wanting from liking) mapped this. Popular write-ups - like Big Think's \"why your brain loves games\" - flatten it to \"dopamine isn't pleasure,\" a useful correction that overshoots. The honest version: dopamine is mostly about anticipation and learning, and a hook works by making something worth anticipating.",
    },
    gradeBands: {
  ...
  },
  {
    ...
    dialogueBeats: [
      ...
      "Now the caution, because rewards genuinely can backfire. Pay students for something they already love, and the reward can quietly replace the love with the price. Researchers call this the overjustification effect.",
      ...
      "The most powerful pattern is also the most dangerous: the variable one. Unpredictable, intermittent rewards - the slot-machine schedule - are the most habit-forming, because they keep dopamine guessing. Popular advice says to add randomness. But that is exactly the lever loot boxes and infinite feeds pull, so reach for it only in rare, transparent moments.",
    ...
    cautionCard: {
      ...
      items: [
        ...
        { id: "variable-reward", risk: "Variable-reward (slot-machine) design", text: "Random, unpredictable rewards - B.F. Skinner's variable-ratio schedule - are the most habit-forming, the engine behind loot boxes and infinite feeds. Keep classroom rewards predictable and tied to the thinking, not surprise drops engineered for compulsion." },
      ],
    },
    bonusCheck: {
      id: "backfire-check",

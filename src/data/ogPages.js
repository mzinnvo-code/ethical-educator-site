...
export const OG_PAGES = [
  ...
  { id: "ai-ethics-lesson-plans", title: "AI Ethics Lesson Plans for Teachers", section: "Free classroom-ready resources", accent: OG_ACCENTS.teal },
  { id: "thought-experiments-for-kids", title: "Thought Experiments for Kids", section: "Philosophy and AI ethics by grade band", accent: OG_ACCENTS.gold },
  { id: "ai-literacy-activities", title: "AI Literacy Activities for K-12 Classrooms", section: "Activities, prompts, rubrics, and tools", accent: OG_ACCENTS.ocean },
  { id: "school-ai-policy-tools", title: "School AI Policy Tools", section: "Policy builder, rubric, and staff PD", accent: OG_ACCENTS.gold },
  { id: "academic-integrity-ai-discussions", title: "AI Academic Integrity Discussions", section: "Authorship, detectors, honesty, and policy", accent: OG_ACCENTS.coral },
  { id: "philosophy-for-kids", title: "Philosophy for Kids", section: "Teacher-friendly classroom philosophy", accent: OG_ACCENTS.teal },
  ...
  { id: "teaching-resources/paperclip-maximizer", title: "Paperclip Maximizer Classroom Packet", section: "Teacher Resource", accent: OG_ACCENTS.ocean },
  { id: "teaching-resources/consciousness-line", title: "The Consciousness Line Lesson Packets", section: "Teacher Resource", accent: OG_ACCENTS.coral },
  { id: "teaching-resources/ai-authorship-discussion", title: "AI Authorship Classroom Discussion", section: "Teacher Resource", accent: OG_ACCENTS.gold },
  { id: "teaching-resources/ai-detector-false-positive", title: "AI Detector False Positive Discussion", section: "Teacher Resource", accent: OG_ACCENTS.coral },
  { id: "teaching-resources/biased-classroom-robot", title: "Biased Classroom Robot Discussion", section: "Teacher Resource", accent: OG_ACCENTS.teal },
  { id: "teaching-resources/school-surveillance", title: "School Surveillance Scenario", section: "Teacher Resource", accent: OG_ACCENTS.ocean },
  { id: "teaching-resources/ai-grading-mistake", title: "AI Grading Mistake Scenario", section: "Teacher Resource", accent: OG_ACCENTS.gold },
  { id: "teaching-resources/ai-policy-design-staff-activity", title: "AI Policy Design Staff Activity", section: "Teacher Resource", accent: OG_ACCENTS.teal },
  ...
  { id: "gamification-teacher-kit", title: "Gameful Learning Teacher Kit", section: "Printable companion", accent: OG_ACCENTS.coral },

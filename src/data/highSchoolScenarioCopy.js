  ...
  "marys-room": {
    ...
    stages: [
      ...
      },
      {
        ...
        storySections: [
          section("The situation", "Mary is a thought experiment. Riya is a real student who has just joined your class. She was born without sight. She is fluent in the science of color, the cultural associations of red, the literary uses of color across every novel you have read this year."),
          section("The pressure", "Sitting next to you, Riya asks the obvious question: 'Do I know red?' Your answer about Mary now has a face attached to it. A view of knowing that locks Riya out has consequences in the room you are actually in."),
          section("The question", "Disability philosophers including Susanna Siegel have pressed hard on views that treat phenomenal experience as the only real knowledge. The Mary's Room intuition cuts cleanly — but it cuts through real people, too."),
        ],
        prompt: "What is the honest answer to Riya's question?",
        options: [
          { label: "A", text: "Yes. Her knowledge of red is real, built through language, science, and a lifetime of association.", reflection: "You refuse to flatten Riya's hard-won understanding into a single visual channel she does not have. The cost: you've now committed to a kind of knowing that an AI could also claim.", lens: "knows" },
          { label: "B", text: "No. She knows about red, but not the redness of red.", reflection: "You hold the line — knowing about is not knowing what it is like. Block, Chalmers, and the phenomenal-consciousness lineage agree. You'll need this distinction to do real work when AI starts describing its experience.", lens: "doesnt" },
          { label: "C", text: "Both. There are several kinds of knowing, and Riya has several.", reflection: "Generous, but it costs something: you now have to decide which kinds AI plausibly has and which it doesn't. The all-or-nothing shortcut is gone.", lens: "both" },
        ],
        counterpoint: "If phenomenal experience is the key to knowing red, then anyone who has not seen red is locked out of 'real' color knowledge. That is a heavy implication — defended by some, rejected by others.",
      },
      {
        id: "ai",
        ...
        storySections: [
          ...
          section("The pressure", "The output is rich. But does the system know what red is like, or only how humans talk about what red is like? Whatever you said about Riya, the same reasoning has to apply here — or you'll need to explain why not."),
        ...
        options: [
          { label: "A", text: "No. Pattern-matching is not experience, no matter how convincing the output.", reflection: "You distinguish linguistic performance from phenomenal consciousness. The model lives in Mary's room and may never leave. Convincing description is evidence of what language can do, not evidence of phenomenal access.", lens: "no" },
          { label: "B", text: "Yes — perhaps differently than humans, but the model knows red in its own way.", reflection: "You shift from inner feeling to functional use. The kind of knowing that comes from billions of contextual associations is its own form of understanding. Why privilege the phenomenal?", lens: "yes" },
          { label: "C", text: "We can't tell — and the uncertainty itself is the most important fact.", reflection: "Whether there is anything it is like to be the model is a question we have no reliable way to answer. Sebo and Long argued this uncertainty should make us cautious in both directions when designing AI policy.", lens: "unknown" },
        ],
        counterpoint: "Three rooms, one question. Where you draw your lines tells you something about what knowledge is — and what we owe to AI, to disabled epistemic access, and to each other.",
      },
    ...
    philosophyLab: lab({
      ...
      variationPrompt: "Create a Mary's Room for music, pain, friendship, grief, or an AI trained only on text. Then ask what a real student missing that sense would or wouldn't know.",
